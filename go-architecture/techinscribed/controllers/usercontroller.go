...
func NewUserBaseHandler(userRepo models.UserRepository) *BaseHandler {
	return &BaseHandler{
		userRepo: userRepo,
	}
}

func (h *UserBaseHandler) HelloWorld(w http.ResponseWriter, r *http.Request) {
...
func (h *UserBaseHandler) FindById(w http.ResponseWriter, r *http.Request) {
